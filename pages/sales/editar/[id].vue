<template>
    <div>
                ...
                <div class="col-md-9">
                    <div class="page-prehead">
                        <div class="breadcrumb">
                            <NuxtLink class="breadcrumb__item" to="/sales">Entitats</NuxtLink>
                            <NuxtLink  class="breadcrumb__item" :to="`/sales/${id}`">{{ data.name }}</NuxtLink >
        ...
        <Modal id="RoomConfirmChanges" @save="discardChanges"
            @cancel="$hideBootstrapModal('RoomConfirmChanges')">
            <template #title>
...
<script setup>
    ...
    const discardChanges = () => {
        ...
        imageFile.value = null;
        nuxtApp.$hideBootstrapModal('RoomConfirmChanges');
    };

    const showModal = (props, callback) => {
        callback();
        nuxtApp.$showBootstrapModal('RoomConfirmChanges');
    }
</script>
